...
uint16_t CRC16_1(uint8_t* pchMsg,uint16_t wDataLen)
{
        ...
        while (temp--)
        {
                ...
                chCRCLo = (uint8_t)(chCRCHi ^ chCRCHTalbe[wIndex]);
                chCRCHi = chCRCLTalbe[wIndex] ;
            
        }

  /*      
    wIndex = ((chCRCHi&0xF0)>>4);
      printf("\r\n 1crc %d    %d\r\n",chCRCHi,wIndex); 
    if(wIndex<10)
    {
       wIndex += 0x30;
     ...
     */
        ...
        temp = ((chCRCHi << 8) | chCRCLo);

        //printf("\r\n 2crc %d    %d   %d\r\n",chCRCHi,chCRCLo,temp); 
